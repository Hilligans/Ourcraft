...
public class SettingsScreen extends ScreenBase {
    ...
    public SettingsScreen() {
        widgets.add(new SliderWidget("Sensitivity",50, 50, 200, 40, 50, 300, (int)Camera.sensitivity, value -> Camera.sensitivity = value));
        widgets.add(new SliderWidget("FOV",50, 150, 200, 40, 10, 110, Camera.fov, value -> Camera.fov = value));
        widgets.add(new SliderWidget("Render Distance", 50, 250, 200, 40, 2, 64, Settings.renderDistance, value -> Settings.renderDistance = value));
        ...
        widgets.add(new Button(300, 50, 200, 40, "Sound Options", () -> ClientMain.getClient().openScreen(new VolumeScreen())));
