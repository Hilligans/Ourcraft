...
import dev.hilligans.engine.client.graphics.layout.events.LClickEvent;
import dev.hilligans.engine.client.graphics.layout.events.LKeyEvent;
import dev.hilligans.engine.client.graphics.layout.events.LMouseEvent;
import dev.hilligans.engine.client.graphics.layout.events.LWidgetEvent;
...
public abstract sealed class LWidget permits LBox, LCustomWidget, LImage, LList, LRenderable, LText {
    ...
    public WidgetSize widgetSize = new WidgetSize(100, 100);
    public WidgetPosition widgetPosition = new WidgetPosition(0, 0);
    ...
    public void setParent(LWidget parent) {
        this.parent = parent;
    }
    public LWidget getParent() {
        return this.parent;
    }
